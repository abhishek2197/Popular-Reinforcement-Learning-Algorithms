...
class CriticNetwork(nn.module):
	def __init__(self, stdim, acdim):
		...
		self.finallay_state_action.weight.data.uniform__(-0.005, 0.005)
	...
	def forward(self, state, action):
		...
		out_state_action_first = nn.functional.ReLu(firstlay_state_action(state_action))
		q_state_action = nn.functional.tanh(finallay_state_action(out_state_action_first))
